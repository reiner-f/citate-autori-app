...
export default function ManagePage() {
  ...
  async function handleSubmit(e) {
    ...
    // Dacă validarea eşuează, oprim execuția aici.
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="sticky top-0 z-10 bg-white shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <h1 className="text-2xl font-bold text-indigo-600">0 Administrare citate</h1>
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 space-y-10">
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            {/* noValidate dezactivează validarea nativă a browserului - o gestionăm noi manual pentru mai mult control */}
            ...
            <div>
              ...
              <div className="flex justify-between mt-1">
                ...
                {/* Contorul devine roşu când se apropie de limita de 500 */}
